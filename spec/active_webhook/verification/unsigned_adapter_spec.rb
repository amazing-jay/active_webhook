...
require "active_webhook/verification/unsigned_adapter"

RSpec.describe ActiveWebhook::Verification::UnsignedAdapter, config: :defaults do
  before do
    ActiveWebhook.configure { |config| config.verification.adapter = :unsigned }
  end
